...
#Converts a dictionary with rational (frac or fmpq) entries to rational (frac or fmpq) representations of p-adic numbers to the specified accuracy.
...
class fmpq_mseries:
    ...
    def __mul__(self, other):
        if isinstance(other, fmpq_mseries):
            ...
            new_nmax = min(self.nmax + other.min_degree(),
                           other.nmax + self.min_degree())
    ...
    def __add__(self,other):
        if isinstance(other, fmpq_mseries):
            ...
            #Compute the polynomial addition and turn it into a dictionary
